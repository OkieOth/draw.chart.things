// This file is basically a copy of the svgo package from ajstarks/svgo. I decided to include it
// directly to easier manage the changes I made to the package. The original package can be found at
// https://github.com/ajstarks/svgo
// Thank you for the efforts of the original author, ajstarks.
//
...
func (svg *SVG) TextWithId(id string, x int, y int, t string, s ...string) {
	svg.printf(`<text id="%s" %s %s`, id, loc(x, y), endstyle(s, ">"))
	xml.Escape(svg.Writer, []byte(t))
	svg.println(`</text>`)
}
